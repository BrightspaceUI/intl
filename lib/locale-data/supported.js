...
export const supportedBaseLocales = ['ar', 'ca', 'cy', 'da', 'de', 'en', 'es', 'fr', 'haw', 'hi', 'ja', 'ko', 'mi', 'nl', 'pt', 'sv', 'th', 'tr', 'vi', 'zh', 'ru'];
export const supportedLangpacks = ['ar', 'ca', 'cy', 'da', 'de', 'en-gb', 'en', 'es-es', 'es', 'fr-fr', 'fr-on', 'fr', 'haw', 'hi', 'ja', 'ko', 'mi', 'nl', 'pt', 'sv', 'th', 'tr', 'vi', 'zh-cn', 'zh-tw', 'ru'];
export const supportedLocalesDetails = [
	...
	{ id: 18, code: 'es-mx', source: 'es-MX', pack: 'es', overrideCode: 'es-419', dir: 'ltr', name: 'español (México)' },
	...
	{ id: 32, code: 'fr-on', source: 'fr-CA', pack: 'fr-on', overrideCode: 'fr-CA-Ontario', dir: 'ltr', name: 'français (Canada, Ontario)' },
	...
	{ id: 17, code: 'zh-cn', source: 'zh', pack: 'zh-cn', overrideCode: 'zh', dir: 'ltr', name: '中文' },
	{ id: 20, code: 'zh-tw', source: 'zh-Hant', pack: 'zh-tw', overrideCode: 'zh-Hant', dir: 'ltr', name: '中文 (繁體)' },
...
export function resolveSupportedLocale(localeTags) {
	...
	for (const localeTag of localeTags) {
		...
		const locale = supportedLocalesDetails.find(l => l.pack === lang);
		if (locale) {
			return locale.overrideCode || locale.source;
		}
	}
