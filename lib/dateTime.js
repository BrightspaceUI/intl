...
const hour24locales = ['ca', 'cy', 'da', 'de', 'es', 'fr', 'nl', 'pt', 'sv', 'tr', 'zh'];
const mondayFirstDayLocales = ['ca', 'cy', 'da', 'de', 'fr', 'hi', 'mi', 'nl', 'sv', 'tr'];
...
function getTimeFormat(hour24, language, baseLanguage) {
	...
	if (hour24 && (baseLanguage === 'ca' || baseLanguage === 'ja' || language === 'pt-br' || (baseLanguage === 'zh' && language !== 'zh-tw'))) {
		timeFormat = 'H:mm';
