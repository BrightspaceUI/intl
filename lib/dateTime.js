...
export function getDateTimeDescriptor() {
	...
	return settings.getCacheItem('dateTimeDescriptor', () => {
		...
		const dateFormats = {
			...
			'short': convertCldrDatePattern(localeData.dateFormats.short, true),
			...
			'longDayOfWeek': 'cccc',
			'shortDayOfWeek': convertCldrDatePattern(localeData.dateFormatItems.E, false),
			'longMonth': 'LLLL',
			'shortMonth': convertCldrDatePattern(localeData.dateFormatItems.MMM, false)
		};
