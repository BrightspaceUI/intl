...
export const getLocalizeClass = (superclass = class {}) => class LocalizeClass extends superclass {
	...
	pristine = true;
	localize = LocalizeClass.documentLocaleSettings.pseudoLocalization?.isAvailable
		? LocalizeClass.#pseudoLocalize
		: (...args) => this.localize(...args);
	...
	static #pseudoLocalize(...args) {
		return this.documentLocaleSettings.pseudoLocalization.textFormat.replace(this.localize(...args));
	}
