...
class DocumentLocaleSettings {
	...
	reset() {
		...
		this._listeners = [];
		this.pseudoLocalization = { isAvailable: true, isEnabledForUser: false, textFormat: '{0}' };
	...
	sync() {
		...
		this.pseudoLocalization = this._tryParseHtmlElemAttr('data-pseudo-localization', { isAvailable: false, isEnabledForUser: false, replaceString: '', textFormat: '{0}' });
