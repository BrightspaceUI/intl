...
describe('dateTime', () => {
	...
	describe('formatTime', () => {
		...
		[
			...
			{locale: 'pt', expect: ['1:28', '1:28', '1:28 EST', '1:28 EST', '13:52', '13:52', '13:52 EST', '13:52 EST']},
	...
	describe('formatDate', () => {
		...
		[
			{locale: 'ar', expect: ['الثلاثاء, 4 يونيو, 2019', '04 يونيو, 2019', '04/06/2019', 'يونيو, 2019', '4 يونيو']},
			{locale: 'ar-SA', expect: ['الثلاثاء, 4 يونيو, 2019', '04 يونيو, 2019', '04/06/2019', 'يونيو, 2019', '4 يونيو']},
			{locale: 'da', expect: ['tirsdag den 4. M06 2019', '4. M06. 2019', '04/06/2019', 'M06 2019', '4. M06']},
			{locale: 'da-DK', expect: ['tirsdag den 4. M06 2019', '4. M06. 2019', '04/06/2019', 'M06 2019', '4. M06']},
			{locale: 'de', expect: ['Dienstag 4. M06 2019', '4. M06 2019', '04-06-2019', 'M06 2019', '4. M06']},
			{locale: 'de-DE', expect: ['Dienstag 4. M06 2019', '4. M06 2019', '04-06-2019', 'M06 2019', '4. M06']},
			{locale: 'en', expect: ['Tuesday, June 4, 2019', 'Jun 4, 2019', '6/4/2019', 'June 2019', 'June 4']},
			...
			{locale: 'ja', expect: ['2019年6月4日', '2019年6月4日', '2019/06/04', '2019年6月', '6月4日']},
			{locale: 'ja-JP', expect: ['2019年6月4日', '2019年6月4日', '2019/06/04', '2019年6月', '6月4日']},
			{locale: 'ko', expect: ['2019년 6월 4일 화요일', '2019년 6월 4일', '2019-06-04', '2019년 6월', '6월 4일']},
			{locale: 'ko-KR', expect: ['2019년 6월 4일 화요일', '2019년 6월 4일', '2019-06-04', '2019년 6월', '6월 4일']},
			{locale: 'nl', expect: ['dinsdag 4 M06 2019', '4 M06 2019', '04-06-2019', 'M06 2019', '4 M06']},
			{locale: 'nl-NL', expect: ['dinsdag 4 M06 2019', '4 M06 2019', '04-06-2019', 'M06 2019', '4 M06']},
			{locale: 'pt-BR', expect: ['terça-feira, 4 de junho de 2019', '4 de  junho de 2019', '4/6/2019', 'junho de 2019', '04 de junho']},
			{locale: 'sv', expect: ['Tisdag den 4 Juni 2019', '4 Juni 2019', '2019-06-04', 'Juni 2019', '04 Juni']},
			{locale: 'sv-SE', expect: ['Tisdag den 4 Juni 2019', '4 Juni 2019', '2019-06-04', 'Juni 2019', '04 Juni']},
			{locale: 'tr', expect: ['04 Haziran 2019 Salı', '04 Haziran 2019', '04.06.2019', 'Haziran 2019', '04 Haziran']},
			{locale: 'tr-TR', expect: ['04 Haziran 2019 Salı', '04 Haziran 2019', '04.06.2019', 'Haziran 2019', '04 Haziran']},
			{locale: 'zh', expect: ['2019年6月4日', '2019年6月4日', '2019/6/4', '2019年6月', '6月4日']},
