...
describe('dateTime', () => {
	...
	describe('converting date/time', () => {
		...
		function getExpectedResult(month, day, minute, expectedHours) {
			// adjust hours and day if day change
			if (expectedHours >= 24) {
				expectedHours -= 24;
				day++;
			} else if (expectedHours < 0) {
				expectedHours = 24 + expectedHours;
				day--;
			}

			// half hour/45 min case
			let expectedMinute = minute;
			if ((expectedHours % 1) !== 0) {
				expectedMinute = minute + 60 * (expectedHours % 1);
				if (expectedMinute > 60) {
					expectedMinute -= 60;
					expectedHours += 1;
				}
				expectedHours = Math.floor(expectedHours);
			}

			// add 0 to front of single digit hour
			if (expectedHours < 10) {
				expectedHours = `0${expectedHours}`;
			}

			return `${month} ${day} 2015 ${expectedHours}:${expectedMinute}:00`;
		}
		...
		describe('convertUTCToLocalDateTime', () => {
			[
				...
				it(`should have expected GMT offset of ${test.expectedGMTOffset} for timezone ${test.timezone}`, () => {
					...
					const expectedHours = hours + (date.getTimezoneOffset() / 60) + test.expectedGMTOffset;
					const expectedResult = getExpectedResult('Aug', day, minute, expectedHours);
					expect(result.toString()).to.contain(expectedResult);
				});
			});
		...
		describe('convertLocalToUTCDateTime', () => {
			[
				...
				it(`should have expected GMT offset of ${test.expectedGMTOffset} for timezone ${test.timezone}`, () => {
					documentLocaleSettings.timezone.identifier = test.timezone;
					const expectedHours = hours + test.expectedGMTOffset * -1;
					const expectedResult = getExpectedResult('Aug', day, minute, expectedHours);
	...
	describe('formatTime', () => {
		...
		[
			...
			{locale: 'da', expect: ['01:28', '01:28', '01:28 EST', '01:28 EST', '13:52', '13:52', '13:52 EST', '13:52 EST']},
			{locale: 'da-DK', expect: ['01:28', '01:28', '01:28 EST', '01:28 EST', '13:52', '13:52', '13:52 EST', '13:52 EST']},
			{locale: 'de', expect: ['01:28', '01:28', '01:28 EST', '01:28 EST', '13:52', '13:52', '13:52 EST', '13:52 EST']},
			...
			{locale: 'nl', expect: ['01:28', '01:28', '01:28 EST', '01:28 EST', '13:52', '13:52', '13:52 EST', '13:52 EST']},
	...
	describe('parseTime', () => {
		...
		describe('all locales', () => {
			...
			[
				{locale: 'ar', inputs: ['1:28 ص', '1:28', '1:52 م', '13:52']},
				{locale: 'ar-SA', inputs: ['1:28 ص', '1:28', '1:52 م', '13:52']},
				{locale: 'da', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'da-DK', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'de', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'de-DE', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'en', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				...
				{locale: 'ja', inputs: [/*'1:28 午前'*/'01:28', '1:28', '1:52 午後', '13:52']},
				{locale: 'ja-JP', inputs: [/*'1:28 午前'*/'01:28', '1:28', '1:52 午後', '13:52']},
				{locale: 'ko', inputs: [/*'오전 1:28'*/'01:28', '1:28', '오후 1:52', '13:52']},
				{locale: 'ko-KR', inputs: [/*'오전 1:28'*/'01:28', '1:28', '오후 1:52', '13:52']},
				{locale: 'nl', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'nl-NL', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'pt', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'pt-BR', inputs: ['1:28 AM', '1:28', '1:52 PM', '13:52']},
				{locale: 'sv', inputs: ['01:28 FM', '01:28', '1:52 EM', '13:52']},
				{locale: 'sv-SE', inputs: ['01:28 FM', '01:28', '1:52 EM', '13:52']},
				{locale: 'tr', inputs: [/*'01:28 ÖÖ'*/'01:28', '01:28', '1:52 ÖS', '13:52']},
	...
	describe('formatDate', () => {
		...
		[
			...
			{locale: 'da', expect: ['tirsdag den 4. M06 2019', '4. M06. 2019', '04/06/2019', 'M06 2019', '4. M06', 'tirsdag', 'tir.', 'M06', 'M06']},
			{locale: 'da-DK', expect: ['tirsdag den 4. M06 2019', '4. M06. 2019', '04/06/2019', 'M06 2019', '4. M06', 'tirsdag', 'tir.', 'M06', 'M06']},
			{locale: 'de', expect: ['Dienstag 4. M06 2019', '4. M06 2019', '04-06-2019', 'M06 2019', '4. M06', 'Dienstag', 'Di.', 'M06', 'M06']},
			{locale: 'de-DE', expect: ['Dienstag 4. M06 2019', '4. M06 2019', '04-06-2019', 'M06 2019', '4. M06', 'Dienstag', 'Di.', 'M06', 'M06']},
			...
			{locale: 'fr', expect: ['mardi 4 juin 2019', '4 juin 2019', '04/06/2019', 'juin 2019', '4 juin', 'mardi', 'mar.', 'juin', 'juin']},
			{locale: 'fr-FR', expect: ['mardi 4 juin 2019', '4 juin 2019', '04/06/2019', 'juin 2019', '4 juin', 'mardi', 'mar.', 'juin', 'juin']},
			...
			{locale: 'nl', expect: ['dinsdag 4 M06 2019', '4 M06 2019', '04-06-2019', 'M06 2019', '4 M06', 'dinsdag', 'di', 'M06', 'M06']},
			{locale: 'nl-NL', expect: ['dinsdag 4 M06 2019', '4 M06 2019', '04-06-2019', 'M06 2019', '4 M06', 'dinsdag', 'di', 'M06', 'M06']},
			...
			{locale: 'pt-BR', expect: ['terça-feira, 4 de junho de 2019', '4 de  junho de 2019', '4/6/2019', 'junho de 2019', '04 de junho', 'terça-feira', 'ter', 'junho', 'jun']},
			{locale: 'sv', expect: ['Tisdag den 4 Juni 2019', '4 Juni 2019', '2019-06-04', 'Juni 2019', '04 Juni', 'Tisdag', 'Tis', 'Juni', 'Jun']},
			{locale: 'sv-SE', expect: ['Tisdag den 4 Juni 2019', '4 Juni 2019', '2019-06-04', 'Juni 2019', '04 Juni', 'Tisdag', 'Tis', 'Juni', 'Jun']},
