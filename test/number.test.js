...
describe('number', () => {
	...
	describe('formatNumber', () => {
		...
		[
			...
			{ locale: 'ca', expect: ['42', '-42', '0,392', '-0,392', '1.234.567.890', '-1.234.567.890'] },
			{ locale: 'ca-ES', expect: ['42', '-42', '0,392', '-0,392', '1.234.567.890', '-1.234.567.890'] },
	...
	describe('formatPercent', () => {
		...
		[
			...
			{ locale: 'ca', expect: ['42%', '-42%'] },
			{ locale: 'ca-ES', expect: ['42%', '-42%'] },
	...
	describe('parseNumber', () => {
		...
		describe('all locales', () => {
			...
			[
				...
				{ locale: 'ca', inputs: ['42', '-42', '0,392', '-0,392', '1.234.567.890', '-1.234.567.890'] },
				{ locale: 'ca-ES', inputs: ['42', '-42', '0,392', '-0,392', '1.234.567.890', '-1.234.567.890'] },
