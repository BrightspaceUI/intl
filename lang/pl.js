export default {
	...
	"intl-common:actions:close": "Zamknij", // close action (in Title Case)
	"intl-common:actions:confirm": "Potwierdź", // confirm action (in Title Case)
	...
	"intl-common:actions:insert": "Wstaw", // insert action (in Title Case)
	...
	"intl-common:characters:colon": "dwukropek", // short name or description of the ":" character
	...
	"intl-common:characters:quotationMark": "cudzysłów", // short name or description of the '"' character
	"intl-common:confirm:no": "Nie", // no response to a question (in Title Case)
	"intl-common:confirm:ok": "OK", // okay response to a question
	"intl-common:confirm:yes": "Tak", // yes response to a question (in Title Case)
	"intl-common:navigation:back:title": "Wstecz", // term for navigating back to the previous page (in Title Case)
	"intl-common:navigation:continue:title": "Kontynuuj", // continue action (in Title Case)
	"intl-common:navigation:next:title": "Dalej", // term for navigating to the next page or item (in Title Case)
	"intl-common:navigation:previous:title": "Poprzedni", // term for navigating to the previous page or item (in Title Case)
};
