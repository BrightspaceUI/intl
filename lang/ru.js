export default {
	...
	"intl-common:actions:confirm": "Подтвердите", // confirm action (in Title Case)
	"intl-common:actions:copy": "Копия", // copy action (in Title Case)
	"intl-common:actions:create": "Создать", // create action (in Title Case)
	...
	"intl-common:actions:insert": "Вставить", // insert action (in Title Case)
	...
	"intl-common:actions:saveAndNew": "Сохранить и создать", // save and new action (in Title Case)
	"intl-common:actions:search": "Поиск", // search action (in Title Case)
	"intl-common:actions:submit": "Отправить", // submit action (in Title Case)
	"intl-common:actions:update": "Обновить", // update action (in Title Case)
	"intl-common:characters:ampersand": "Амперсанд", // short name or description of the "&" character
	"intl-common:characters:apostrophe": "Апостроф", // short name or description of the "'" character
	"intl-common:characters:asterisk": "Звездочка", // short name or description of the "*" character
	...
	"intl-common:characters:pipe": "труба", // short name or description of the "|" character
	"intl-common:characters:questionMark": "Вопросительный знак", // short name or description of the "?" character
	"intl-common:characters:quotationMark": "кавычка", // short name or description of the '"' character
	"intl-common:confirm:no": "Нет", // no response to a question (in Title Case)
	"intl-common:confirm:ok": "OK", // okay response to a question
	"intl-common:confirm:yes": "Да", // yes response to a question (in Title Case)
