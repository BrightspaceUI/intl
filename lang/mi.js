export default {
	...
	"intl-common:actions:browse": "Whakarapopototia", // browse action (in Title Case)
	...
	"intl-common:actions:delete": "Muku", // delete action (in Title Case)
	...
	"intl-common:actions:insert": "Kōkuhu", // insert action (in Title Case)
	...
	"intl-common:actions:search": "Rapu", // search action (in Title Case)
